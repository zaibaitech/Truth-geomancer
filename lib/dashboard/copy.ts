// Prompt 61: centralized static dashboard copy. Kept in one small module
...
export const HERO_VALUE_PROP = {
  ...
  body: 'Explore classical geomantic knowledge through the books and interactive tools of Truth Geomancer.',
  cta: 'Begin a Casting',
  href: '/raml',
} as const;

export const EXPLORE_BOOKS_COPY = {
  heading: 'Explore the Books',
  body: 'Discover the books behind the tradition — and explore their methods inside Truth Geomancer.',
} as const;

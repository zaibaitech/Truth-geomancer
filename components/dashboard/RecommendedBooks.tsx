    ...
    <div className="px-4">
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-1.5">
          ...
          <h2 className="text-sm font-semibold text-sand-light">Recommended Books</h2>
        </div>
        <Link href="/books" className="flex items-center gap-1 text-xs font-medium text-clay-light">
